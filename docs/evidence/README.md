...
Supporting captures for the dissertation *Measuring the Unmeasured* (Uririe,
Orume Dominic; MSc Artificial Intelligence and Business Strategy, Aston
University, 2026). Each image is reproduced in Appendix F of the dissertation.

Items already shown as figures in the body (the hosted report view, the
before-and-after scope captures, the installation transcript) are not repeated
here.
...
|---|---|---|---|
| F.1 | `E1_field_audit_govsignal.jpg` | GovSignal audited on a third party's machine: 30 files, 1,923 lines; security 2.26, complexity 4.79, duplication 0.89%, scope drift 4 | Table 4.6, §4.8 |
| F.2 | `E2_field_audit_kya_rails.jpg` | kya-rails, a codebase outside the study: 43 files, 4,620 lines; scope drift 0.00 | Table 4.6, §4.8 |
| F.3 | `E3_self_audit.jpg` | The instrument scored against the study's demonstration specification, reading 19. This is the wrong-brief artefact §4.8 describes; the figure of record is 12 | §4.8.1 |
| F.4 | `E4_pypi_downloads.jpg` | Public installation counts to 5 September 2026: 2,500 all-time, 880 in 30 days, 232 in 24 hours | §4.8, adoption |
